...
<body>
    ...
    <div class="main">
        ...
        <div class="card">
            ...
            <a class="ctc">Arena Tun Tuanku Haji Bujang, Universiti Malaysia Sarawak, 94300 Kota Samarahan, Sarawak,
                Malaysia</a><br>
            <a></a><br>
            ...
            <a href="https://www.google.com/maps/dir//Tun+Tuanku+Haji+Bujang+Arena,+Jln+Kapur,+94300+Kota+Samarahan,+Sarawak/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x31fba22d4a9d015f:0xcd36cae9c9f1517?sa=X&ved=2ahUKEwjx-K-BxuaDAxV0oWMGHZVPAFoQ48ADegQIExAA"
                target="_blank">
                <iframe width="600" height="450" style="border:0; margin-left: 12rem; margin-top: 1rem;" loading="lazy"
                    allowfullscreen src="/UnimasArena/src/Resources/Image/map.png">
                </iframe>
            </a>
