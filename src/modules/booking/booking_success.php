...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">Your booking has been successfully added! Please wait for the confirmation email before proceeding to use the court. Thank you for your patience.</h5>
    ...
    <a href="/UnimasArena/src/UserHome.php" class="btn btn-primary">Return Home</a>
  </div>
</div>
