...
<head>
    ...
    <link  rel="stylesheet" href="public/css/edit-booking.css">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($result->num_rows > 0){
        ...
        try {
            $stmt->execute();
            header('Location: bookingRequest.php'); // Redirect back to ViewBooking.php
        } catch (Exception $e) {
...
<div class="card">
<form id="bookingForm" action="adminEdit.php" method="POST">
        ...
        <select id="court" name="court" class="booking-period">
            ...
            <button type="button" onclick="window.location.href='bookingRequest.php'">Cancel</button>
        </form>
</div>
<?php
}
